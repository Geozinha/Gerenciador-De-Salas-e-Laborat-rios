...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function checkInputs() {
        const nomeProfessorValue = nomeProfessor.value.trim();
        const identificadorValue = identificadorProfessor.value.trim();
        const emailProfessorValue = emailProfessor.value.trim();
        const senhaProfessorValue = senhaProfessor.value.trim();
